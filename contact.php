    ...
    <div class="container2">
        <div class="head2">
            ...
            <div class="content_area guide">
                ...
                <h3>POLICE HEAD QUARTERS, <br>
                    SECRETARIAT HILLS, <br>
                    SHILLONG-793001, <br>
                    MEGHALAYA</h3> <br>

                <p>For any query regarding this website, please contact the web information manager through email id: admin&#64;police.nic.in</p>

                <h3><a href="https://megpolice.gov.in/telephone" target="_blank" style="color: blue;">Telephone</a></h3>
            </div>
        </div>
    </div>
